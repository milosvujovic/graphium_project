...
JOIN partnerships on partnerships.viewing_organisation_id = users.organisation_id 
WHERE users.organisation_id = @OrganisationID and files.access_level != 'private' 
ORDER BY files.date;
END //
DELIMITER ;